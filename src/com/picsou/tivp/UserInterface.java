...
public class UserInterface extends BasicGame {
    ...
    public void init(GameContainer gameContainer) throws SlickException {
        ...
        mainFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
...
//        }
        ...
        stationDisplay = new Slider("Station display", 8, 72, 10, 30, 40, 66);
        stationDisplay.setValue(35);
...
//            System.out.println("End of update, current time = " + mainFormat.format(currentTimestamp));
    ...
    /**
     * Modifies the trip's start or end so as to spread the bike traffic over the city
     *
     * @param trip the original trip
     * @return the modified trip
     */
...
//            System.out.println("Improving bike parking");
            ...
            if (in.getNeighbordsAmount() >= 1) {
                ...
                trip.setIn_station(newStop.getId());
                trip.setActiveUser(true);
            }
    ...
    /**
     * Triggers the display of the potential hovered station's tooltip
     *
     * @param input
     */
...
//            System.out.println("xCorrection : " + xCorrection + " yCorrection : " + yCorrection + " lat : " + paris.getCenterLatitude() + " long : " + paris.getCenterLongitude());
    ...
    /**
     *
     * @return the list of {@link Trip} currently starting or ending
     */
