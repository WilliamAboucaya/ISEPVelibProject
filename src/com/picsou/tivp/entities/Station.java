...
public class Station {
    ...
    /**
     *
     * @return true if this station has less than 10% or more than 90%  of its bike places filled
     */
    ...
    /**
     * Draws the state of this station as a colored disk
     *
     * @param graphics the graphical container in which the state will be drawn
     * @param xCorrection
     * @param yCorrection
     */
...
//        System.out.println("Drawing " + address + " x : " + x + " y : " + y + " lat : " + latitude + " long : " + longitude );
    ...
    /**
     * Draws the informations of the station in a white rectangle
     *
