...
public class Slider {
    ...
    /**
     * Updates the cursor's position according to the mouse pointer's position
     * @param input
     */
    ...
    public int getValue() { return (int) (min + value); }

    public void setValue(int value) { this.value = value - (int) min; }
